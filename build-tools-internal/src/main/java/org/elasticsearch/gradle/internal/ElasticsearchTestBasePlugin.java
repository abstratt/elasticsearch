        ...
        project.getTasks().withType(Test.class).configureEach(test -> {
            ...
            test.doFirst(new Action<>() {
                ...
                public void execute(Task t) {
                    ...
                    mkdirs(heapdumpDir);
                    // getWorkingDir() now returns DirectoryProperty in EAP; unwrap to File with .get().getAsFile()
            ...
            test.getJvmArgumentProviders().add(() -> {
                // getJavaVersion() now returns Provider<JavaVersion> in EAP; call .get() to resolve
            ...
            if (disableAssertions) {
                ...
                // setEnableAssertions(boolean) removed in EAP; use the property API instead
            ...
            test.testLogging(logging -> {
                // setShowExceptions/setShowCauses/setExceptionFormat removed in EAP; use the property API instead
